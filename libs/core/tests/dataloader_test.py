def test_import():
    from perception_models import core
    assert core
...
# from perception_models.core.plm.dataset_conf import dataset_config as DATASET_CONFIGS
# from perception_models.core.plm.tokenizer import PLMTokenizer
